...
public class TestCentro {
	...
	public void setUp() throws Exception {
		  ...
		  ctro = new CentroMedico("Clinica Fuertes", "30-77888999-5", 5000.0);

		  // nombre, valor de consulta
		  ctro.agregarEspecialidad("Cardiologia", 2000.0);
		  ctro.agregarEspecialidad("Dermatologia", 1500.0);
		  ctro.agregarEspecialidad("Pediatria", 1200.0);
		  
		  // nombre, matricula, especialidad, valor de tratamiento
		  ctro.agregarMedico("Rene Vena", 12345, "Cardiologia", 20000.0);
		  ctro.agregarMedico("Susana Cortez", 34567, "Dermatologia", 15000.0);
		  ctro.agregarMedico("Mario Piazza", 56789, "Pediatria", 12000.0);
	 ...
	 public void testSaldoPacientePrivado() throws Exception {
	  assertEquals(5000.0,ctro.getSaldo(321),10);
	  ctro.pagarSaldo(321);
	  assertEquals(0.0,ctro.getSaldo(321),1);
	 }

	 @Test
	 public void testSaldoPacienteOSocial() throws Exception {
	 ...
	 @Test
	 public void testSaldoPacienteAmbulatorio() throws Exception {
	  assertEquals(27000.0,ctro.getSaldo(543),10);
	  ctro.pagarSaldo(543);
	  assertEquals(0.0,ctro.getSaldo(543),1);
	 }
	 ...
	 @Test
	 public void testListaInternacion() throws Exception {
